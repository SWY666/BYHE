...
def get_args_parser():
    ...
    parser.add_argument('--mask_path', default='X:/vipl-frame/mask_list', type=str,
                        help="""Please specify path to the 'mask_list' as GT.""")
    parser.add_argument('--wave_path', default='X:/vipl-frame/wave_gt', type=str,
    ...
    parser.add_argument('--output_dir', default='./saved/', type=str, help="""Path to save logs and checkpoints.""")
    ...
    parser.add_argument('--num_workers', default=0, type=int, help="""Number of data loading workers per GPU. (default: 
                        0)""")
    parser.add_argument('--batch_size', default=1, type=int, help="""batch-size: number of distinct images loaded on GPU.
                        (default: 6)""")
    ...
    parser.add_argument('--min_lr', default=1e-6, type=float, help="""Target LR at the end of optimization. We use a cosine
    ...
    parser.add_argument("--warmup_epochs", default=0, type=int, help="""Number of epochs for the linear learning-rate warm
                         up. (default: 20)""")
    parser.add_argument('--weight_decay', default=1e-5, type=float, help="""Initial value of the weight decay. With ViT, a 
                        smaller value at the beginning of training works well. (default: 1e-5)""")
    parser.add_argument('--weight_decay_end', default=1e-3, type=float, help="""Final value of the weight decay. We use a 
